...
class TestMul(TestCase):
    ...
    def test_medium_mul(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(450, 550, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(550, 650, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    ...
    def test_large_mul(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(1450, 1550, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(1550, 1650, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestPow(TestCase):
    ...
    def test_large_pow(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(600, 600, seed=0)
        is_correct, speed_up = compute([dp_mat, 14], [nc_mat, 14], "pow")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestSlice(TestCase):
    ...
    def test_dealloc(self):
        ...
        dp_mat = 45
        nc_mat = 45
        self.assertTrue(cmp_dp_nc_matrix(dp_col, nc_col))
